...
# Initialization of the order list
orders = []
...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            print("-------|--------------------------|-------")
            item_selection = input("Type number of item you want or m to "
                                       "back on main menu:")
            ...
            if item_selection == 'm':
                ...
                # Tell the customer that their input isn't valid
                    ...
                    print("Selected item number does not exist in the menu.")
            else:
                print("Invalid input. Please enter a number or 'm' to go back.")
        else:
        ...
        print("Invalid input. Please enter a number between 1 and 4.")
            # Order status
    total_cost = sum(item['Price'] * item['Quantity'] for item in orders)  # Calculation of the total price
    print(menu_dashes)
...
for order in orders:
    ...
    print(f"{item_name:25} | ${price:<6}|   {quantity}")
